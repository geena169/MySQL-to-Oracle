# Получение файлов данных таблиц
# Из исходного файла по маркерам находтся строки ввода данных в таблицы
# Они группируются по файлам для дальнейшей обработки
